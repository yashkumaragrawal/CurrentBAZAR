...
if(isset($_POST['username']) && isset($_POST['gmail'])) {
  ...
  include '../localhost.php';
      ...
      $query = "UPDATE adminlogin SET username = '$username',user_gmail = '$gmail' WHERE user_gmail = '$gmail'";
    ...
    <script src="js/bootstrap.min.js"></script>
          ...
          If you want to go on Home Page then press<a href="under.php"> OK</a></i></h4></div>
          </body>
           </html>';
    }  
  } 
